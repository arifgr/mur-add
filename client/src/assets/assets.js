import logo from "./11902097_speaker_audio_system_music_and_icon.svg";
...
import electronics_headphones from "./976606_appliances_electronics_headphones_loud_music_icon.png";
import electronics_karaoke_mic from "./976608_appliances_electronics_karaoke_mic_microphone_icon.png";
import audio_blast_music_sound from "./976609_appliances_audio_blast_music_sound_icon.png";
import sound_speakers from "./976622_appliances_display_entertainment system_sound_speakers_icon.png";
import music_sound_volume from "./3250075_electronics_music_sound_volume_icon.png";
...
export const categories = [
  {
    text: "Headphones",
    path: "Headphones",
    image: electronics_headphones,
    bgColor: "#FEF6DA",
  },
  {
    text: "Microphones",
    path: "Microphones",
    image: electronics_karaoke_mic,
    bgColor: "#FEE0E0",
  },
  {
    text: "Sound Systems",
    path: "SoundSystems",
    image: audio_blast_music_sound,
    bgColor: "#F0F5DE",
  },
  {
    text: "Sound Speakers",
    path: "SoundSpeakers",
    image: sound_speakers,
    bgColor: "#E1F5EC",
  },
  {
    text: "Speakers & Audio",
    path: "SpeakersAudio",
    image: speaker_audio_system,
    bgColor: "#FEE6CD",
  },
  {
  ...
  },
  {
    text: "Sound & Music",
    path: "Sound",
    image: microphone_sound_speak,
    bgColor: "#F1E3F9",
  },
  {
    text: "Volume Control",
    path: "VolumeControl",
    image: music_sound_volume,
    bgColor: "#F1E3F9",
  },
];
...
export const features = [
  {
    ...
    description: "Electronics delivered in under 10 days.",
  },
  {
    icon: leaf_icon,
    title: "High Technology",
    description: "High Technology Guaranteed",
  },
  {
    icon: coin_icon,
